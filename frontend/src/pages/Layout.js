...
const Layout = () => {
  ...
  const submit = async (e) => {
    ...
    try {
      const response = await axios.post("http://localhost:8000/login/adminlogin", data);
  ...
  const membersubmit = async (e) => {
    ...
    try {
      const response = await axios.post("http://localhost:8000/login/memberlogin", member);
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div className="d-flex">
              {!members ? (
                <>
                  <button
                    className="btn btn-outline-dark mx-1 custom-btn animate-btn"
                    type="button"
